...
def get_tipo_sindicato_queryset():
    return TipoSindicato.objects.all()


def filter_tipo_sindicato_queryset(queryset, *, activo=None, q=None):
...
__all__ = ["filter_tipo_sindicato_queryset", "get_tipo_sindicato_queryset"]
